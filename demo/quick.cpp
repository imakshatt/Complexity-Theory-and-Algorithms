...
int main()
{
    ...
    for (int size : sizes)
    {
        ...
        for (int pivot_choice = 0; pivot_choice < 4; ++pivot_choice)
        {
            ...
            cout << ", Ascending Order, Time Taken: " << elapsed_time << " seconds" << endl;
            ...
            cout << ", Descending Order, Time Taken: " << elapsed_time << " seconds" << endl;
            ...
            cout << ", Random Order, Time Taken: " << elapsed_time << " seconds" << endl;
        }
    }
